...
if(consultasSQL::UpdateSQL("proveedor", "NombreProveedor='$nameProveUp',Direccion='$dirProveUp',Telefono='$telProveUp',PaginaWeb='$webProveUp',Pago='$pagoProveUp',Estado='$estadoProveUp',Cuenta='$cuentaProveUp'", "NITProveedor='$nitOldProveUp'")){
    echo '<script>
        swal({
